...
from legged_lab.assets.unitree.unitree_g123dof import UNITREE_G1_23DOF_CFG as ROBOT_CFG
from legged_lab.envs.unitree import mdp
...
class ObservationsCfg:
    ...
    @configclass
    class AmpObsExpertTrans(ObsGroup):
        amp = ObsTerm(func=mdp.MotionObservation, params={
    ...
    amp_obs_for_expert_trans = AmpObsExpertTrans()
...
class RewardsCfg:
    ...
    feet_too_near = RewTerm(
        ...
        weight=-2.0,
        params={"asset_cfg": SceneEntityCfg("robot", body_names=[".*ankle_roll.*"]), "threshold": 0.26},
    )
