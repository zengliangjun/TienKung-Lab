...
def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene):
    ...
    while simulation_app.is_running():
        ...
        if False:
            ...
            joint_pos[:, left_arm_ids] = motion_dof_pos[:, mujoco_left_arm_ids]
            joint_pos[:, right_arm_ids] = motion_dof_pos[:, mujoco_right_arm_ids]

            joint_vel[:, left_leg_ids] = motion_dof_vel[:, mujoco_left_leg_ids]
            joint_vel[:, right_leg_ids] = motion_dof_vel[:, mujoco_right_leg_ids]
            joint_vel[:, left_arm_ids] = motion_dof_vel[:, mujoco_left_arm_ids]
            joint_vel[:, right_arm_ids] = motion_dof_vel[:, mujoco_right_arm_ids]
